...
#best scorers in the nba regular season
...
#most efficient scorers in the playoffs
select name,team, ORtg, 2PA, 2P, 3PA, 3P, eFG, TS, PPG
from nba_playoff_stats
where MPG > 30 and GP > 8 and PPG > 20 
order by TS desc limit 10;

select play.name,play.team, play.ORtg, play.eFG, play.TS, play.PPG,
reg.ORtg, reg.eFG, reg.TS, reg.PPG, (play.TS - reg.TS) as incTS
from nba_playoff_stats play
join nba_regular_season_stats reg
on play.name = reg.name
where play.MPG > 30 and play.GP > 8 and reg.PPG > 20 
order by incTS limit 10;
